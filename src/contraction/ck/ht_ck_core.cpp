									...
									void *workspace, uint64_t workspaceSize, hipStream_t stream)
{
    ...
    hiptensorPrintVectorElements<ck::index_t>
        (std::vector<ck::index_t>(plan->ht_plan_desc.ht_contract_attr_desc[0].strides.begin(), plan->ht_plan_desc.ht_contract_attr_desc[0].strides.end()));
    std::cout << "Tensor A size: " << plan->ht_plan_desc.ht_contract_attr_desc[0].tensor_size << std::endl;

    hiptensorPrintVectorElements<ck::index_t>
        (std::vector<ck::index_t>(plan->ht_plan_desc.ht_contract_attr_desc[1].lens.begin(), plan->ht_plan_desc.ht_contract_attr_desc[1].lens.end()));
    hiptensorPrintVectorElements<ck::index_t>
        (std::vector<ck::index_t>(plan->ht_plan_desc.ht_contract_attr_desc[1].strides.begin(), plan->ht_plan_desc.ht_contract_attr_desc[1].strides.end()));
    std::cout << "Tensor B size: " << plan->ht_plan_desc.ht_contract_attr_desc[1].tensor_size << std::endl;

    hiptensorPrintVectorElements<ck::index_t>
        (std::vector<ck::index_t>(plan->ht_plan_desc.ht_contract_attr_desc[2].lens.begin(), plan->ht_plan_desc.ht_contract_attr_desc[2].lens.end()));
    hiptensorPrintVectorElements<ck::index_t>
        (std::vector<ck::index_t>(plan->ht_plan_desc.ht_contract_attr_desc[2].strides.begin(), plan->ht_plan_desc.ht_contract_attr_desc[2].strides.end()));
    std::cout << "Tensor C size: " << plan->ht_plan_desc.ht_contract_attr_desc[2].tensor_size << std::endl;
	
    hip_check_error(hipMalloc(static_cast<void**>(&output), plan->ht_plan_desc.ht_contract_attr_desc[2].tensor_size));
    ...
    auto contraction_bilinear = [&] (auto &op_layout)
    {
        ...
        auto argument_ptr  = op->MakeArgumentPointer(
                           ...
                           std::vector<ck::index_t>(plan->ht_plan_desc.ht_contract_attr_desc[1].lens.begin(), plan->ht_plan_desc.ht_contract_attr_desc[1].lens.end()),
                           std::vector<ck::index_t>(plan->ht_plan_desc.ht_contract_attr_desc[1].strides.begin(), plan->ht_plan_desc.ht_contract_attr_desc[1].strides.end()),
                           std::array<std::vector<ck::index_t>, 1> {std::vector<ck::index_t>(plan->ht_plan_desc.ht_contract_attr_desc[2].lens.begin(),
                                                                                             plan->ht_plan_desc.ht_contract_attr_desc[2].lens.end())},
                           std::array<std::vector<ck::index_t>, 1> {std::vector<ck::index_t>(plan->ht_plan_desc.ht_contract_attr_desc[2].strides.begin(),
    ...
    hip_check_error(hipMemcpy(D, output, plan->ht_plan_desc.ht_contract_attr_desc[2].tensor_size, hipMemcpyDeviceToDevice));
