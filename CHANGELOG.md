...
* Added hiptensorCreatePlanPreference to allocate the hiptensorPlanPreference_t and enable users to limit the applicable kernels for a given plan/operation.
...
* Replaced hipDataType with hiptensorDataType_t for all supported types e.g. HIP_R_32F -> HIPTENSOR_R_32F.
