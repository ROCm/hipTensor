...
## (Unreleased) hipTensor 1.2.0 for ROCm 6.1.0
...
* Data type support
  * Contraction - new supported data type f16, bf16, complex f32, complex f64

### Fixes

* Fixed bug in congtraction calculation with data type f32
